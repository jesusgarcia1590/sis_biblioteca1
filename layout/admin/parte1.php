...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>/admin" class="brand-link">
      <img src="https://cdmx.ciesas.edu.mx/wp-content/uploads/2018/11/Libros.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">
            <?php echo $sesion_nombres.' '.$sesion_apellidos; ?>
          </a>
        </div>
      </div>
